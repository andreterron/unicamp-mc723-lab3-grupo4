...
#undef AC_SYSC
    ...
    default:
      ...
      instr_vec = new ac_instr<mips_parms::AC_DEC_FIELD_NUMBER>( instr_dec);
      ...
      case 57: // Instruction sys_call
        ...
        break;
      case 58: // Instruction instr_break
        if (!ac_annul_sig) ISA._behavior_mips_Type_R(instr_vec->get(1), instr_vec->get(2), instr_vec->get(3), instr_vec->get(4), instr_vec->get(5), instr_vec->get(6));
