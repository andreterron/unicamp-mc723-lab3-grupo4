...
ac_dec_format mips_parms::mips_isa::formats[mips_parms::AC_DEC_FORMAT_NUMBER] = {
  {"Type_R", 32, &(mips_parms::mips_isa::fields[0]), &(mips_parms::mips_isa::formats[1])},
  {"Type_I", 32, &(mips_parms::mips_isa::fields[6]), &(mips_parms::mips_isa::formats[2])},
  {"Type_J", 32, &(mips_parms::mips_isa::fields[10]), NULL}
};
...
ac_dec_list mips_parms::mips_isa::dec_list[mips_parms::AC_DEC_LIST_NUMBER] = {
  ...
  {"func", 6, 0, NULL},
  {"op", 1, 0, &(mips_parms::mips_isa::dec_list[44])},
  {"func", 6, 2, NULL},
  {"op", 1, 0, &(mips_parms::mips_isa::dec_list[46])},
  {"func", 6, 3, NULL},
  {"op", 1, 0, &(mips_parms::mips_isa::dec_list[48])},
  {"func", 6, 4, NULL},
  {"op", 1, 0, &(mips_parms::mips_isa::dec_list[50])},
  {"func", 6, 6, NULL},
  {"op", 1, 0, &(mips_parms::mips_isa::dec_list[52])},
  {"func", 6, 7, NULL},
  ...
  {"op", 1, 4, NULL},
  {"op", 1, 5, NULL},
  {"op", 1, 6, &(mips_parms::mips_isa::dec_list[78])},
  {"rt", 3, 0, NULL},
  {"op", 1, 7, &(mips_parms::mips_isa::dec_list[80])},
  {"rt", 3, 0, NULL},
  {"op", 1, 1, &(mips_parms::mips_isa::dec_list[82])},
  {"rt", 3, 0, NULL},
  {"op", 1, 1, &(mips_parms::mips_isa::dec_list[84])},
  {"rt", 3, 1, NULL},
  {"op", 1, 1, &(mips_parms::mips_isa::dec_list[86])},
  {"rt", 3, 16, NULL},
  {"op", 1, 1, &(mips_parms::mips_isa::dec_list[88])},
  {"rt", 3, 17, NULL},
  {"op", 1, 0, &(mips_parms::mips_isa::dec_list[90])},
  {"func", 6, 12, NULL},
  {"op", 1, 0, &(mips_parms::mips_isa::dec_list[92])},
  {"func", 6, 13, NULL}
};
...
ac_dec_instr mips_parms::mips_isa::instructions[mips_parms::AC_DEC_INSTR_NUMBER] = {
  ...
  {"addi", 4, "addi", "addi %reg, %reg, %exp", "Type_I", 13, 1, 1, 1, &(mips_parms::mips_isa::dec_list[12]), 0, &(mips_parms::mips_isa::instructions[13])},
  ...
  {"add", 4, "add", "add %reg, %reg, %reg", "Type_R", 21, 1, 1, 1, &(mips_parms::mips_isa::dec_list[21]), 0, &(mips_parms::mips_isa::instructions[21])},
  {"addu", 4, "addu", "addu %reg, %reg, %reg", "Type_R", 22, 1, 1, 1, &(mips_parms::mips_isa::dec_list[23]), 0, &(mips_parms::mips_isa::instructions[22])},
  {"sub", 4, "sub", "sub %reg, %reg, %reg", "Type_R", 23, 1, 1, 1, &(mips_parms::mips_isa::dec_list[25]), 0, &(mips_parms::mips_isa::instructions[23])},
  {"subu", 4, "subu", "subu %reg, %reg, %reg", "Type_R", 24, 1, 1, 1, &(mips_parms::mips_isa::dec_list[27]), 0, &(mips_parms::mips_isa::instructions[24])},
  ...
  {"sll", 4, "sll", "sll %reg, %reg, %imm", "Type_R", 31, 1, 1, 1, &(mips_parms::mips_isa::dec_list[41]), 0, &(mips_parms::mips_isa::instructions[31])},
  {"srl", 4, "srl", "srl %reg, %reg, %imm", "Type_R", 32, 1, 1, 1, &(mips_parms::mips_isa::dec_list[43]), 0, &(mips_parms::mips_isa::instructions[32])},
  {"sra", 4, "sra", "sra %reg, %reg, %imm", "Type_R", 33, 1, 1, 1, &(mips_parms::mips_isa::dec_list[45]), 0, &(mips_parms::mips_isa::instructions[33])},
  {"sllv", 4, "sllv", "sllv %reg, %reg, %reg", "Type_R", 34, 1, 1, 1, &(mips_parms::mips_isa::dec_list[47]), 0, &(mips_parms::mips_isa::instructions[34])},
  {"srlv", 4, "srlv", "srlv %reg, %reg, %reg", "Type_R", 35, 1, 1, 1, &(mips_parms::mips_isa::dec_list[49]), 0, &(mips_parms::mips_isa::instructions[35])},
  {"srav", 4, "srav", "srav %reg, %reg, %reg", "Type_R", 36, 1, 1, 1, &(mips_parms::mips_isa::dec_list[51]), 0, &(mips_parms::mips_isa::instructions[36])},
  {"mult", 4, "mult", "mult %reg, %reg", "Type_R", 37, 1, 1, 1, &(mips_parms::mips_isa::dec_list[53]), 0, &(mips_parms::mips_isa::instructions[37])},
  {"multu", 4, "multu", "multu %reg, %reg", "Type_R", 38, 1, 1, 1, &(mips_parms::mips_isa::dec_list[55]), 0, &(mips_parms::mips_isa::instructions[38])},
  {"div", 4, "div", "div %reg, %reg", "Type_R", 39, 1, 1, 1, &(mips_parms::mips_isa::dec_list[57]), 0, &(mips_parms::mips_isa::instructions[39])},
  {"divu", 4, "divu", "divu %reg, %reg", "Type_R", 40, 1, 1, 1, &(mips_parms::mips_isa::dec_list[59]), 0, &(mips_parms::mips_isa::instructions[40])},
  {"mfhi", 4, "mfhi", "mfhi %reg", "Type_R", 41, 1, 1, 1, &(mips_parms::mips_isa::dec_list[61]), 0, &(mips_parms::mips_isa::instructions[41])},
  {"mthi", 4, "mthi", "mthi %reg", "Type_R", 42, 1, 1, 1, &(mips_parms::mips_isa::dec_list[63]), 0, &(mips_parms::mips_isa::instructions[42])},
  {"mflo", 4, "mflo", "mflo %reg", "Type_R", 43, 1, 1, 1, &(mips_parms::mips_isa::dec_list[65]), 0, &(mips_parms::mips_isa::instructions[43])},
  {"mtlo", 4, "mtlo", "mtlo %reg", "Type_R", 44, 1, 1, 1, &(mips_parms::mips_isa::dec_list[67]), 0, &(mips_parms::mips_isa::instructions[44])},
  {"j", 4, "j", "j %exp(align)", "Type_J", 45, 1, 1, 1, &(mips_parms::mips_isa::dec_list[69]), 0, &(mips_parms::mips_isa::instructions[45])},
  {"jal", 4, "jal", "jal %exp(align)", "Type_J", 46, 1, 1, 1, &(mips_parms::mips_isa::dec_list[70]), 0, &(mips_parms::mips_isa::instructions[46])},
  {"jr", 4, "jr", "jr %reg", "Type_R", 47, 1, 1, 1, &(mips_parms::mips_isa::dec_list[71]), 0, &(mips_parms::mips_isa::instructions[47])},
  {"jalr", 4, "jalr", "jalr %reg, %reg", "Type_R", 48, 1, 1, 1, &(mips_parms::mips_isa::dec_list[73]), 0, &(mips_parms::mips_isa::instructions[48])},
  {"beq", 4, "beq", "beq %reg, %reg, %exp(pcrel)", "Type_I", 49, 1, 1, 1, &(mips_parms::mips_isa::dec_list[75]), 0, &(mips_parms::mips_isa::instructions[49])},
  {"bne", 4, "bgtu", "bgtu %reg, $0, %exp(pcrel)", "Type_I", 50, 1, 1, 1, &(mips_parms::mips_isa::dec_list[76]), 0, &(mips_parms::mips_isa::instructions[50])},
  {"blez", 4, "blez", "blez %reg, %exp(pcrel)", "Type_I", 51, 1, 1, 1, &(mips_parms::mips_isa::dec_list[77]), 0, &(mips_parms::mips_isa::instructions[51])},
  {"bgtz", 4, "bgtz", "bgtz %reg, %exp(pcrel)", "Type_I", 52, 1, 1, 1, &(mips_parms::mips_isa::dec_list[79]), 0, &(mips_parms::mips_isa::instructions[52])},
  {"bltz", 4, "bltz", "bltz %reg, %exp(pcrel)", "Type_I", 53, 1, 1, 1, &(mips_parms::mips_isa::dec_list[81]), 0, &(mips_parms::mips_isa::instructions[53])},
  {"bgez", 4, "bgez", "bgez %reg, %exp(pcrel)", "Type_I", 54, 1, 1, 1, &(mips_parms::mips_isa::dec_list[83]), 0, &(mips_parms::mips_isa::instructions[54])},
  {"bltzal", 4, "bltzal", "bltzal %reg, %exp(pcrel)", "Type_I", 55, 1, 1, 1, &(mips_parms::mips_isa::dec_list[85]), 0, &(mips_parms::mips_isa::instructions[55])},
  {"bgezal", 4, "bgezal", "bgezal %reg, %exp(pcrel)", "Type_I", 56, 1, 1, 1, &(mips_parms::mips_isa::dec_list[87]), 0, &(mips_parms::mips_isa::instructions[56])},
  {"sys_call", 4, "syscall", "syscall", "Type_R", 57, 1, 1, 1, &(mips_parms::mips_isa::dec_list[89]), 0, &(mips_parms::mips_isa::instructions[57])},
  {"instr_break", 4, "break", "break", "Type_R", 58, 1, 1, 1, &(mips_parms::mips_isa::dec_list[91]), 0, NULL}
};
...
mips_parms::mips_isa::instr_table[mips_parms::AC_DEC_INSTR_NUMBER + 1] = {
  ...
  ac_instr_info(31, "sll", "sll", 4),
  ac_instr_info(32, "srl", "srl", 4),
  ac_instr_info(33, "sra", "sra", 4),
  ac_instr_info(34, "sllv", "sllv", 4),
  ac_instr_info(35, "srlv", "srlv", 4),
  ac_instr_info(36, "srav", "srav", 4),
  ac_instr_info(37, "mult", "mult", 4),
  ac_instr_info(38, "multu", "multu", 4),
  ac_instr_info(39, "div", "div", 4),
  ac_instr_info(40, "divu", "divu", 4),
  ac_instr_info(41, "mfhi", "mfhi", 4),
  ac_instr_info(42, "mthi", "mthi", 4),
  ac_instr_info(43, "mflo", "mflo", 4),
  ac_instr_info(44, "mtlo", "mtlo", 4),
  ac_instr_info(45, "j", "j", 4),
  ac_instr_info(46, "jal", "jal", 4),
  ac_instr_info(47, "jr", "jr", 4),
  ac_instr_info(48, "jalr", "jalr", 4),
  ac_instr_info(49, "beq", "beq", 4),
  ac_instr_info(50, "bne", "bgtu", 4),
  ac_instr_info(51, "blez", "blez", 4),
  ac_instr_info(52, "bgtz", "bgtz", 4),
  ac_instr_info(53, "bltz", "bltz", 4),
  ac_instr_info(54, "bgez", "bgez", 4),
  ac_instr_info(55, "bltzal", "bltzal", 4),
  ac_instr_info(56, "bgezal", "bgezal", 4),
  ac_instr_info(57, "sys_call", "syscall", 4),
